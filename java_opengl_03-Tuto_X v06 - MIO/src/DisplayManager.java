...
public class DisplayManager {
	 ...
	 * 
	 * 
	 * * Crea una ventana de visualización en la que podemos renderizar nuestro juego. Las dimensiones
* de la ventana se determinan configurando el modo de visualización. Mediante el uso
* "glViewport" le decimos a OpenGL qué parte de la ventana queremos mostrar
...
* 
	 ...
	 * 
	 * 
	 *  Este método se usa para actualizar la pantalla al final de cada cuadro. Cuando
* hemos configurado un proceso de renderizado; este método mostrará lo que sea
* hemos estado renderizando en la pantalla. El método de "sincronización" se usa aquí para
* limitar la velocidad de cuadros. Sin esto, la computadora simplemente trataría de ejecutar el
* juego tan rápido como sea posible, haciendo más trabajo de lo necesario.
	 */
